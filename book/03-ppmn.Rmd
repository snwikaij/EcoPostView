...
For the three parameter sigmoidal equation used of which the name is `sigmoidal`. b0 describes the asymptote, b1 the midpoint and b2 the scale parameter. Indeed multiple parents are possible with this function which continues at b4. The parameters then enter as $b_1-x_1+\sum_{p=4}^P( b_p\cdotx_2)$ and continue from $b_4$ onwards. However, this function seems relatively unstable.
...
For the gompertz equation the name is `gompertz`. In this equation, b0 is the asymptote, b1 is the displacement constant and b2 is the growth rate. This function also allows other parameters to access the equation $b_1-x_1+\sum_{p=4}^P( b_p\cdotx_2)$ similair to the sigmoidal equation, but has the same curse.
...
The Bayesian classifier is an equation that makes use of the mean and standard deviation of two groups. The name of this edge function is `class`. In this equation b0 and b1 are the mean and standard deviation of group 1, respectively. b2 and b3 are the mean and standard deviation of group 2. b5 is the proportion of group 1.
