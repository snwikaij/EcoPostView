...
```{r, sigmoidal model fit, fig.width=8, fig.height=3.5, echo=F, warning=FALSE}
...
```{r, gompertz model fit, fig.width=8, fig.height=3.5, echo=F, warning=FALSE}
...
$$
```{r, gaussian model fit, fig.width=8, fig.height=3.5, echo=F, warning=FALSE}
...
```{r, bayes clasifier plot, fig.width=8, fig.height=3.5, echo=F, warning=FALSE}
