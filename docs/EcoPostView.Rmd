...
salinity_df <- example1[example1$predictor %in% "Salinity"  & example1$group %in% "Invertebrates" & example1$link %in% "logit" & example1$parameter %in% "b1",]
...
#Display the most aesthetically appealling figure without adjusting the x-axis
print(fig$figures[[1]])
...
# Authenticity and reasons to believe
...
Major premise  1) $all \ insects \ have \ six \ legs,$ <br>
Minor  premise  2) $x \ is \ an \ insect,$ <br>
Conclusion) $\therefore \ x \ has \ six \ legs$ <br>
...
Major premise  1)$all \ P \ are \ Q,$ <br>
Minor  premise  2)$x \ is \ P,$ <br>
Conclusion)$therefore \ x \ is \ Q$ <br>
...
Modus Ponens: $for \ all \ x \ that \ are \ P \ it \ implies \ they \ are \ Q, x \ is \ P \ therefore \ x \ is \ Q$
Modus Tollens: $for \ all \ x \ that \ are \ P \ it \ implies \ they \ are \ Q, x \ is \ \neg Q \ therefore \ x \ is \ \neg P$
Hypothetical Syllogism: $for \ all \ x \ that \ are \ P \ it \ implies \ they \ are \ Q, for \ all \ x \ that \ are \ Q \ it \ implies \ they \ are \ Z, \ x \ is \ P \ therefore \ x \ is \ Z$
Disjunctive Syllogism: $either \ x \ is \ P \ or \ x \ is \ Q, x \ is \neg P \ therefore \ x \ is \ Q$
...
Modes Ponens: $\forall x(P(x)\rightarrow Q(x)), P(x) \vdash Q(x)$ <br>
Modes Tollens: $\forall x(P(x)\rightarrow Q(x)), \neg Q(x) \vdash \neg P(x)$ <br>
Hypotehtical Syllogism: $ \forall x(P(x)\rightarrow Q(x)) \wedge \forall x(Q(x) \rightarrow Z(x)), P(x) \rightarrow Z(x)$ <br>
Disjunctive Syllogism:$P(x) \vee Q(x), \neg P(x) \vdash Q(x)$ <br>
