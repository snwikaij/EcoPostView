...
mod1 <- meta(estimate=example1$est,         #Model estimate
             ...
             mu_predv=example1$mean)      #The mean of the predictor variables (optional but advised)
