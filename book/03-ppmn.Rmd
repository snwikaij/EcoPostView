...
```{r, examp_2_ppmn_b,fig.width=8, fig.height=6, warning=F}
...
```{r, examp_2_ppmn_c, fig.width=8, fig.height=8, warning=F}
...
```{r, upload training data, warning=F}
...
```{r, updating via KL-divergence, fig.width=8, fig.height=8, warning=FALSE}
...
```{r, marginal update plots, fig.width=8, fig.height=6, warning=F}
...
```{r, apply updated pppn to validation data, fig.width=8, fig.height=8, warning=FALSE}
...
```{r, root estimation monte carlo priors, fig.width=8, fig.height=3.5, warning=FALSE}
...
```{r, root estimation 15 and 1 macrophytes, fig.width=8, fig.height=4, warning=FALSE}
...
```{r, figure 15 macrophytes, fig.width=8, fig.height=3.5, warning=FALSE}
...
```{r, figure 1 macrophyte, fig.width=8, fig.height=3.5, warning=FALSE}
...
```{r, sigmoidal model fit, fig.width=8, fig.height=3, warning=FALSE}
...
```{r, gompertz model fit, fig.width=8, fig.height=3, warning=FALSE}
...
$$
```{r, gaussian model fit, fig.width=8, fig.height=3, warning=FALSE}
...
```{r, bayes clasifier plot, fig.width=8, fig.height=3, warning=FALSE}
