...
for a single random effect. It can adjust for the relation between the $se$ and model parameters using the the squared standard error $se^2$ (method=1, Stanley and Doucouliagos, 2014). The structure is then 
