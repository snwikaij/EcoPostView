...
Any conclusion $𝓟_n$ under some condition $c \in C$ in an argument $𝓟_1, …, 𝓟_{n-1} \models 𝓟_n$. Can be suspended based on any other premise that is not certain/conclusive and therefore $𝓟_n$ does not follow. 
...
\\
MC: Valid(s, 𝓟_1, …, 𝓟_{n-1} \models 𝓟_n) 𝓟_n \in \{ 𝓟_1, …, 𝓟_{n-1} \}) = Circulair
\\
MI: \forall n(Valid(s, 𝓟_n) \rightarrow Valid(s, 𝓟_{n-1}) \rightarrow Valid(s, 𝓟_{n-\infty})) = Non-foundational 
$$
