# Meta-epistemic authenticity 

## Introduction

Inquiry, in the broadest sense, concerns itself with the explanation of phenomena - the experiential nature of our senses - and aims to paint a picture of the world. The senses are the major tools of inquiry, seeing, hearing, smelling, touching, tasting and (perhaps controversial) thought (Lusthaus 2002; Zahavi 2025). While thought is often unconventional, when I investigate it, just as the other senses, thoughts come and go, being temporal. Thus, when we speak about the natural world, we do so temporal and subjective about our experience. This subjectivity can be highlighted reflecting on it via phenomenology.

By using signs (abstractions, language, models, drawings, paintings, figures, symbols, etc.) it is sought not only to describe the experience of the world, but also to justify the thoughts that arise from these descriptions (I am justified in believing x results in y because …). Things (objects or facts) can be sensed reflecting on the conceptualized thoughts (or beliefs) we have of them. These concepts are learned via words and gestures (signs/abstractions) by referring to the same experiential nature of the senses (Anat and Anat 2021; Bronzo 2022; Wittgenstein 1953). 

The experience is believed to come from an object or fact, yet the only connection to an object is the experience itself. To suggest the experience of the object to be the object is to presuppose the ontological commitment that all experiences are exactly what they are: ‘reality’. However, our experiences are mediated by language, culture, biology, prior beliefs, ideas and cognition (For example, think about the fear some have of being injected with a needle. This fear is for some severe and others do not understand why).

The phenomenon is a lived experience of the interaction between objects and facts, senses, signs and thought. Objects and facts are not as the things themselves, but as they appear to the eyes of the subject. To grasp what it means to constitute an object is to have a thought of a concept. Either we formed a thought of the concept forcing it upon the object-experience, or the object-experience forced the thought into the concept. The result is a type (concept) and token (individual belonging to the concept) distinction. Without our thoughts of concept types it becomes impossible to delineate the different tokens we experience. 

We can observe species and colours. Yet, these species are only socially defined by a taxonomic system. Colours are experienced but the experience can not be shared. Therefore we define an intersubjective social system - a language - using wavelengths to provide a mentally reproducible definition of colour. 

Only by delineating concepts (language units), such as ‘the grass is green’, makes sense, because of the thought we have of what it means to constitute ‘grass’ and ‘green’. It seems as we create meaning by appointing concepts as properties to objects. Yet, since every meaning asks for more meaning this will eventually show the emptiness of all meaning due to regress. A superficial and contemporary reflection on 'species' shows it is based on a partial reductionist view of species traits (or characteristics) that are coded in its DNA, arising from molecules, consisting of atoms, built from subatomic particles until an underlying model of quantum fields. The challenge is that either the last statement either is questioned on its possibility to be a 'true' reflection of reality (van Fraassen 1980) or an attempt to derive meaning for the phenomenon, where meaning seems only compressed or derived in limited ways (Wittgenstein 2021, Zapffe 1933, Wittgenstein 1953, Woudenberg 2002). 

We dualize ‘the green grass’ from what is not ‘the green grass’. The meaning of it all is intentional, heuristic and pragmatic, from the creation of the atomic bomb to species identification for conservation. Within ‘the green grass’, the water, macro- and micro- nutrients and carbon(-dioxide) are not the grass. However, we do not ask where is the concept of 'the green grass' when we reduce 'the green grass' into its components. This gives rise to more questions than answers. We do not speak about 'the green grass' by summarizing the configuration of its components. Yet, if we cannot summarize the exact components of 'the green grass' the question if we can understand what meaning the utterance 'the green grass' truly entails.

To explain is to reduce the meaning of the concept to its components. But if the components are not understood we cannot understand the concept. What follows is that we do not understand the world, because I cannot imagine one to understand the components of all things. Why physicist search for the theory of everything is not 'science'. They hope to find what it means to be in the universe. By pursuing this they try to make sense of why we experience what we experience. It is through the theory of everything they identify their 'self' (Lusthaus 2002).

As we look back to our daily experience, than it seems 'grass' is a taxonomic classification according to our intentional thought-concepts of taxonomy. Our thoughts and our desires of how it ‘ought’ to be and not what ‘is’ the case. As is the colour green only the experience of the senses and not the green as it is. Hence, it seems only our intentionality - the ‘oughts’ - that justify what it means for ‘the grass to be green’.

To ask 'why' is then a question to 'because of what reason'. It demands ('oughts') an explanation of the phenomenon to show one understands it. This explanation demands to reduce the conceptual meaning of the phenomenon into its components. The rules that connect the components are the ones of signs. And, by citing and following the rules, as if they were the world we show that we are under the illusion of understanding (Wittgenstein 1953, 2003).

The ontological question of what is reality beyond our senses and signs only pursued based on the belief (hope) we will be able to experience reality for what it is without our ‘oughts’. 
The desire to inquire to the ontologically of ‘ought’ and therefore an objective thought from nowhere to be non-existent.

Our subjective experience (the I, ego or identity) is always busy with something. Meaning it itself is thereby a search for duality. Trying to search not for $A=A$, but $A\neq B$. We try to generate context via duality or information via duality. It makes no sense to say that $A=A$ or $all=all$. Then it only makes sense to say 'the green grass' = 'the water, macro- and micro- nutrients and carbon(-dioxide)'. Hence, to learn something is to minimally exclude the belief in one of two propositions.
...
There is no 'I see the green grass'. There is only seeing, or better yet: Being. This is not subjectivity stripped of concepts, but being prior to the need for a subjective heuristic-pragmatic spoon. Duality comes before the experience and before identity. It asks a question: where does the 'grassness' start? Hence there would be no grass without water, carbon dioxide, light etc. There would be no 'grassness' without me assigning the property grassness to the object. 

What objective syntax, beyond my application of reason, do I have to separate the grassness from the water, carbon dioxide and light? What objective reason do I have to separate my experience from the 'greenness'? Without me there would be no grass, there would only be objects without properties (but where would they start and end to be objects?). We acknowledge the properties. It is these questions that drive inquiry.

Often objectivity is viewed or misleadingly portrayed as a domain with no first- or third-person standpoint. No perspective. There is no experience, no subject, no object. Non-being, at least, not in a way that can be spoken of. This is the absolute outside of consciousness. No conditionality, no experience, no relation. Perhaps an extreme form of realism that equally requires extreme ontological commitments. This ontological commitment is often transcendental (e.g., Platonism). 

However, 'objectivity' as a 3th person cannot be a view from nowhere, it is impossible any view or perspective presupposes a stance, and a stance presupposes being. Unconditional objectivity is the silence and emptiness at the edge of thought and language (Wittgenstein 1921). Belief, truth, knowledge, purpose and meaning collapses into presence, presence collapses into silence, and silence gives way to unknowability. The only constant of 'nothingness'. This would be a place without sense, a place we cannot speak, believe and think of a place of nonsense. Hence, to go beyond ourselves means to project our beliefs into nothingness, but this would be to generate ontological commitment to something that cannot be sensed and not be spoken of (Anat and Anat 2021; Wittgenstein 1921).

Therefore, the only relevant object of inquiry is the formulation of the question - and the meaning of the words - 'why am I justified to believe?'

At times, my work may read as critical, pessimistic or even cynical - perhaps in some places it drifts closer to pessimism than I intended. That said, both are undeniably present. This is perhaps because skepticism itself does not allow for epistemic-closure. This means most of the beliefs we hold cannot be justified. Epistemic-closure is denied by the skeptic, although not because of emotive reasons. Yet, to the non-skeptic this seems to be 'negative' (emotive). While I believe humanity has enormous potential for empathy and radical acceptance, which could be cultivated through reasoning, I have not yet found convincing evidence of this in practice. It is often the complete absence of skeptical thought that causes this divide.

## Reasoning and logic

Reasoning and logic should play a central role in everyday life and research (but see Lakbut 2021 and Harman, 1986). In practice, reasoning - especially formal logic - is often not a major concern for many researchers. To be fair, some of the most significant scientific breakthroughs were not the result of formal reasoning (e.g., the discovery of penicillin; see Feyerabend, 1975). Nevertheless, structured reasoning and logic guide our thinking, shape clear arguments, and offer clarity to our thoughts. Perhaps the most immediate benefit of reasoning is not its guarantee of 'truth', but the aesthetic and coherence it brings to our argumentation. Hence, to see the incoherence of our reasoning and thought shows that we cannot accept the majority of our believes.

Despite the previous normative position and values, many conclusions drawn and claims made in contemporary society are not logically valid and sound. This becomes especially evident when one closely examines the syntax of arguments in research papers and popular articles. Perhaps an immediate consequence of understanding logic is the impossibility (or near impossibility) for *empirical* sciences to develop valid and sound arguments. 

Logic, in its formal form, concerns itself with the structure/syntax of arguments: for example, if B follows from A, and C follows from B, then C follows from A. Logic does not concern itself with the 'truth' (or meaning) of A, B, or C - those could just as well be X, Y, Z or $\alpha, \beta, \gamma$. What matters is that the form of reasoning obeys the rules of logic.

It is often argued that reasoning, to some extent, depends on the principles of logic - though some i.e., Harman, 1986 challenge this view. In everyday life, strict logical principles may not always be applicable or followed. Still, this does not diminish their potential instrumental value. Using logical principles can improve the ability to 

(1.) Decide what to believe about the world, 

(2.) clearly communicate our thoughts to others, and 

(3.) better understand the reasoning of others. 

As someone with a background in ecology, I increasingly find that confusion in reasoning does not stem from the world itself but from the way we use (or not use) logic, reason and language specifically, from issues in syntax and semantics. Hence, I see the choice of words (semantics) and the way we lay connection between them (syntatical structure) is more central to research practice - including ecology - than is commonly acknowledged.

## Predicate and epistemic logic

As mentioned, some formal and syntactical logic will be used. I will use some formal expressions - though not strictly within the syntax of formal predicate logic and epistemic logic. These expressions help expose the structure of beliefs and arguments, making their internal syntax explicit. They are concise and avoid the ambiguities of natural language, aiming for a more neutral and formal presentation of meaning. There is less ambiguity about the form of the argument proposed and is useful to highlight confusion. While this is not intended to be a full introduction to logic - but focuses on reasoning - it will address key concepts such as validity, soundness, cogency, ambiguity, vagueness and the formalization of arguments. For a more comprehensive treatment, see Barwise et al. (2002), Lee (2017), and Smith (2021).
I intend it more as a guide for people into the specific style used for syllogism, propositional, predicate, and epistemic logic.
...
$$P \rightarrow Q, Q \rightarrow Z, P \vdash Z $$
