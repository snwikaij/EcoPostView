...
The derivation of Bayes theorem relies on the exchangeability of probabilities, while classically 'A' and 'B' are used.
...
$$
Under different context we can leverage more information over the likelihood using Bayesian Model Averagin (BMA) that does not use a single prior, but multiple priors.
...
## 6.7 A short reflection on uncertainty
