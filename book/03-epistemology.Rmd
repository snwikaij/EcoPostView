...
Inquiry, in the broadest sense, concerns itself with the explanation of phenomena - the experiential nature of our senses - and aims to paint a picture of the world. The senses are the major tools of inquiry, seeing, hearing, smelling, touch, taste and (perhaps controversial) thought (Lusthaus 2002; Zahavi 2025). While thought is often unconventional, when I investigate it, just as the other senses, they come and go, being temporal. Thus when we speak about the natural world, we do temporal and subjectively. This subjectivity can be highlighted reflecting on it via phenomenology.

By using  signs (abstractions, language, models, drawings) it is sought not only to describe the experience of the world, but also to justify the thoughts that arise from these descriptions (I am justified in believing x results in y because …). Things (objects or facts) can be sensed in reflection to the conceptualized thoughts (or beliefs) we have of them. These concepts are learned via words and gestures (signs/abstractions) by referring to the same experiential nature of the senses (Anat and Anat 2021; Bronzo 2022; Wittgenstein 1953). 

The experience is believed to come from an object, yet the only connection to an object is the experience itself. To suggest the experience of the object to be the object, is to presuppose the ontological commitment that all experiences are exactly what they are “reality”. However, our experiences are mediated by language, culture, biology, prior beliefs, ideas and cognition (For example, think about the fear of injecting the pain a needle can have, which for some is severe and others do not understand why).

The phenomenon is a lived experience of the interaction between objects, senses, signs and thought. Objects and facts are not as the things themselves, but as they appear to the eyes of the subject. To grasp what it means to constitute an object is to have a thought of a concept. 
Either we formed a thought of the concept forcing it upon the object-experience, or the object-experience forced the thought into the concept. The resulting type (concept) and token (individual belonging to the concept). Without our thoughts and concepts it becomes impossible to delineate. 

We can observe species and colours. Yet, these species are only socially defined by a taxonomic system. Colours are experienced but the experience can not be shared. Therefore we define an intersubjective social system with wavelengths providing a mentally reproducible definition of colour. 

Only by delineating, ‘the grass is green’ makes sense, solely because of the thought we have of what it means to constitute ‘grass(-ness)’ and ‘green(-ness)’.We appoint properties to objects and based on a partial reductionist view of species traits or characteristics coded in its DNA, arising from molecules, consisting of atoms, built from subatomic particles till an underlying model of quantum fields. 

We dualize ‘the green grass’ from what is not ‘the green grass’ . The meaning of it all is intentional, heuristic and pragmatic from the creation of the atomic bomb to species identification for conservation. Within ‘the green grass’, the water, macro- and micro- nutrients and carbon(-dioxide) are not the grass. However, we do not ask where is the concept of 'the green grass' when we split the grass into its components. This gives rise to more question than answers.

We might say 'grass' is a taxonomic classification according to our intentional thought-concepts of taxonomy. Our thoughts and our desires of how it ‘ought’ to be and not what ‘is’ the case. As is the colour green only the experience of the senses and not the green as it is. Hence, it seems only our intentionality - the ‘oughts’ - that justify what it means for ‘the grass to be green’.
...
Our subjective experience (the I, ego or identity) is always busy with something. Meaning it itself is thereby a search for duality. Trying to search not for A=A, but A=not B. We try to generate context via duality or information via duality. It makes no sense to say that all=all. It makes no sense to say that 'the green grass' = 'the water, macro- and micro- nutrients and carbon(-dioxide)'. Hence, to learn something is to minimally exclude the belief in one of two propositions.
